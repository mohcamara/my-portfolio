...
const Hero = () => {
    return (
        <div className='container mx-auto px-6 pt-24 relative z-10'>
            <section id="home" className="min-h-[80vh] flex flex-col md:flex-row items-center justify-between">
                <motion.div
                ...
                >
                    ...
                    <div className="mt-8 flex items-center space-x-4">
                        ...
                        <a href="https://linkedin.com/in/mohcamara" target="_blank" className="text-gray-400 hover:text-white transition-colors">
