        ...
        <section id="home" className="min-h-[80vh] flex flex-col justify-center">
            <div className="max-w-3xl">
                ...
                <div className="mt-8 flex items-center space-x-4">
                    ...
                    <a href="https://github.com/mdboulet" target="_blank" className="text-gray-400 hover:text-white">
                    ...
                    <a href="https://linkedin.com/in/mdboulet" target="_blank" className="text-gray-400 hover:text-white">
